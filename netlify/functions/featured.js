// MIKAYLA â Featured Look of the Day
...
// Uses direct images.unsplash.com CDN URLs â no deprecated source API.
...
// ââ In-process cache (warm Lambda instances re-use today's result) âââââââââ
const CACHE = {};

// ââ Verified Unsplash fashion photo IDs (confirmed working CDN photos) âââââ
// Curated pools per city â rotated by day of week.
...
// ââ City style context for AI prompt ââââââââââââââââââââââââââââââââââââââ
const CITY_CONTEXT = {
  ...
  rome:           'Roman elegance. Linen, earthy tones, comfortable for cobblestones. Sundresses, ood loafers.',
  ...
  'new york':     'NYC energy. Tailored athleisure, blazers over tees, white sneakers, structured tote.',
...
// ââ Fetch fashion photo directly from Unsplash CDN ââââââââââââââââââââââ
...
async function analysePhoto(base64, mime, city) {
  ...
  var prompt = `You are MIKAYLA's chief fashion AI â part Paris editor, part personal stylist.
You are analysing today's Featured Look for ${city}.
City aesthetic: ${cityCtx}

Identify the complete outfit in this photo. Return ONLY valid JSON â no markdown, no code blocks.

{
  ...
  "rating_reason": "one sentence on why â mention specific pieces",
  ...
  "styling_note": "one editorial tip to make this look even better â specific and actionable",
  "pieces": [
    {
      ...
      "price_luxury": "e.g. Â£280âÂ£620",
      "price_mid": "e.g. Â£85âÂ£160",
      "price_budget": "e.g. Â£22âÂ£45"
    }
  ],
  "missing_to_complete": [
...
// ââ Build buy tiers ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
const TIERS = {
  luxury: [
