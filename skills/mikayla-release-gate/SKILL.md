...
description: Audit MIKAYLA before a website release. Use for functional QA, responsive testing, accessibility, broken links, image provenance, truthfulness, affiliate disclosure, API fallbacks, local storage, itinerary flows, closet upload, visual shopping, outfit studio, and Vercel readiness.
---
...
7. Review source labels, affiliate disclosure, privacy language, and unsupported claims.
